...
Namespace CRM
    Public Class ConnectionHelper
        Const ConnectionString = "XpoProvider=MSSqlServer;data source=ALLIANCE-SQL;user id=madcap;password=ferrett;initial catalog=CRM;Persist Security Info=true"
